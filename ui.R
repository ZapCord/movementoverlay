...
ui <- fluidPage(
  ...
  fluidRow(
    column(1,id="fileinputpanel",
           ...
           helpText("Choose the kinematics or kinetics .csv file from the trial
                    that corresponds with the input video"),
           fileInput("existing_timings_input",
                     label=h5("Step 3: Patient Timings")),
           helpText("Choose the timings .csv file from the trial
                    that corresponds with the input video"),
